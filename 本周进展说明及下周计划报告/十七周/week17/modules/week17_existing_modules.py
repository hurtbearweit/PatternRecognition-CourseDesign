"""Existing IF-YOLO modules required by the week17 YAML files.

These definitions are copied from the current week15 final package so the
handoff package can be installed on a fresh server. They are not new week17
experiments.
"""
...
class CSFMLite(nn.Module):
    """Lightweight CSFM used by the current main model."""
